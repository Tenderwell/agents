...
These rules are mandatory for the default free-plan search behavior and should be followed by this document and any other agent instructions that construct Tenderwell search payloads.
